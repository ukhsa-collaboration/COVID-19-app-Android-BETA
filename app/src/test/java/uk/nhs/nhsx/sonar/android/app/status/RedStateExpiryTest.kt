...
class RedStateExpiryTest {
    ...
    private val now = DateTime.parse("2020-04-23T11:00:00.000+01:00")
    ...
    fun `when symptoms date is today, state is valid until 7 days`() {
        ...
        assertThat(state.until).isEqualTo(DateTime.parse("2020-04-30T07:00:00.000Z"))
    }
    ...
    fun `when symptoms date is yesterday, state is valid until 6 days`() {
        ...
        assertThat(state.until).isEqualTo(DateTime.parse("2020-04-29T07:00:00.000Z"))
    }
    ...
    fun `when symptoms date is 7 days ago, state is valid until tomorrow`() {
        ...
        assertThat(state.until).isEqualTo(DateTime.parse("2020-04-24T07:00:00.000Z"))
    }
